...
namespace Diplom
{
    public partial class Form4 : Form
    {
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection SqlConnection = new SqlConnection(@"Data Source = DESKTOP-PLUK34H; Initial Catalog = Система для технической поддержки; Integrated Security = True");
            SqlConnection.Open();
            var selectedRowIndex = crashDataGridView.CurrentCell.RowIndex;

            var id = Convert.ToInt32(crashDataGridView.Rows[selectedRowIndex].Cells[0].Value);
            var deleteQuery = $"DELETE FROM Incident WHERE Incident_ID = {id}";
            ...
            crashDataGridView.Update();
            crashDataGridView.Refresh();
        }
    }
}
